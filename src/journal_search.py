...
class JournalSearchApp:
    def __init__(self, root):
        self.root = root
        self.root.title("商科外文期刊查询系统 V.1.0")
        ...
        try:
            ...
            if results:
                ...
                for row in results:
                    ...
                    self.result_text.insert(tk.END, "      创刊年份:      " + " " * (label_width - 10) + f"{journal['创刊年份']}\n", "content")
                    ...
                    # JCR评级信息块
                    self.result_text.insert(tk.END, "  2023年JCR评级\n", "section")
                    self.result_text.insert(tk.END, "  _______________\n\n", "divider")
                    self.result_text.insert(tk.END, "      ")
                    self.result_text.insert(tk.END, "影响因子: ", "content")
                    self.result_text.insert(tk.END, f"{journal['JCR IF(2023)']:<20}", "content")
                    self.result_text.insert(tk.END, "JCR分区: ", "content")
                    self.result_text.insert(tk.END, f"{journal['JCR分区(2023)']}\n\n", "content")
                    
                    # 中科院评级信息块
                    self.result_text.insert(tk.END, "  2023年中科院评级\n", "section")
                    self.result_text.insert(tk.END, "  _______________\n\n", "divider")
                    self.result_text.insert(tk.END, "      ")
                    self.result_text.insert(tk.END, "大类学科: ", "content")
                    self.result_text.insert(tk.END, f"{journal['2023年中科院大类学科']:<20}", "content")
                    self.result_text.insert(tk.END, "大类分区: ", "content")
                    self.result_text.insert(tk.END, f"{journal['2023年中科院大类分区']:<20}", "content")
